...
export const closeModalAndCancel = () => ({
  type: ActionTypes.CLOSE_MODAL_AND_CANCEL,
  payload: {},
});

export const closeModalAndSave = () => ({
  type: ActionTypes.CLOSE_MODAL_AND_SAVE,
  payload: {},
});

export const setLocalizationRu = () => ({
  type: ActionTypes.SET_LOCALIZATION_RU,
  payload: {},
});

export const setLocalizationEn = () => ({
  type: ActionTypes.SET_LOCALIZATION_EN,
  payload: {},
});
